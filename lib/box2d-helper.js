...
/**
 * Create a new box2d physics engine world
 * @param  {new box2d.b2Vec2(0,20)} gravity [specified gravity (optional)]
 * @return {[new box2d.b2World]}         [description]
 */
var createWorld = function(gravity) {
    ...
    if (gravity == null) {
        gravity = new box2d.b2Vec2(0,20);
        // console.log("default gravity used");
    }
	var doSleep = true;
